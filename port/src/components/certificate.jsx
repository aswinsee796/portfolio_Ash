...
const PDF1_FILE_URL = "http://localhost:5173/Aws-cloud foundations.pdf";
const PDF2_FILE_URL = "http://localhost:5173/AswinS-Cyber Surakshit .pdf";
const PDF3_FILE_URL = "http://localhost:5173/nptel-design thinking.pdf";
